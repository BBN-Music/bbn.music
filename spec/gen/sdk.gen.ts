...
import type { GetDropsByAdminData, GetDropsByAdminResponse, GetIdByDropsByAdminData, GetIdByDropsByAdminResponse, DeleteIdByFilesByAdminData, GetIdByDownloadByFilesByAdminData, GetIdByDownloadByFilesByAdminResponse, GetGroupsByAdminData, GetGroupsByAdminResponse, GetPayoutsByAdminData, GetPayoutsByAdminResponse, GetUploadByPayoutsByAdminData, GetQueryBySearchByAdminData, GetQueryBySearchByAdminResponse, PostSyncMappingByAdminData, GetWalletsByAdminData, GetWalletsByAdminResponse, GetIdByWalletsByAdminData, GetIdByWalletsByAdminResponse, PatchIdByWalletsByAdminData, PostEmailByAuthData, GetTokenByFromUserInteractionByAuthData, PostCodeByProviderByOauthByAuthData, GetProviderByRedirectByAuthData, PostRefreshAccessTokenByAuthData, PostRegisterByAuthData, PostResetPasswordByAuthData, PostBugTrackData, GetWebhookByStatuspageByIntegrationData, PostWebhookByStatuspageByIntegrationData, PostMusicData, GetArtworkByDropByMusicData, PostReviewByDropByMusicData, GetServicesByDropByMusicData, PostTypeByTypeByDropByMusicData, GetArtistsByMusicData, GetArtistsByMusicResponse, PostArtistsByMusicData, PostArtistsByMusicResponse, GetDropsByMusicData, GetDropsByMusicResponse, GetIdByDownloadByDropByDropsByMusicData, GetIdByDownloadByDropByDropsByMusicResponse, GetUploadByDropByDropsByMusicData, GetIdByDropsByMusicData, GetIdByDropsByMusicResponse, PatchIdByDropsByMusicData, PostShareByDropsByMusicData, PostShareByDropsByMusicResponse, DeleteIdByShareByDropsByMusicData, GetIdByShareByDropsByMusicData, GetIdByShareByDropsByMusicResponse, GetFulldropByMusicData, GetFulldropByMusicResponse, GetGenresByMusicData, GetGenresByMusicResponse, GetSlugByShareByMusicData, GetArtworkBySlugByShareByMusicData, GetSongsByMusicData, GetSongsByMusicResponse, PostSongsByMusicData, PostSongsByMusicResponse, GetIdByDownloadBySongsByMusicData, GetIdByDownloadBySongsByMusicResponse, GetUploadBySongsByMusicData, GetApplicationsByOauthData, GetApplicationsByOauthResponse, PostApplicationsByOauthData, GetIdByDownloadByClientByApplicationsByOauthData, GetIdByDownloadByClientByApplicationsByOauthResponse, DeleteIdByApplicationsByOauthData, GetUploadByApplicationsByOauthData, PostAuthorizeByOauthData, PostTokenByOauthData, GetUserinfoByOauthData, GetUserinfoByOauthResponse, PostValidateByOauthData, GetPayoutsByPaymentData, GetPayoutsByPaymentResponse, GetIdByPayoutsByPaymentData, GetIdByPayoutsByPaymentResponse, GetStatsByPublicData, PutPlaceholderByTasksData, PutPlaceholderByTasksResponse, GetPictureByUserByUserData, PostResendVerifyEmailByMailByUserData, PostTokenByValidateByMailByUserData, PostTokenByValidateByPhoneByUserData, GetUploadByAvatarBySetMeByUserData, PutUserByUserData, PutUserByUserResponse, PatchIdByUsersByUserData, GetWalletData, GetWalletResponse, PutWalletData, PutWalletResponse, GetChatsByWhatsappData, GetChatsByWhatsappResponse, GetEventByWhatsappData, PostEventByWhatsappData } from './types.gen.ts';
import { zGetDropsByAdminResponse, zGetIdByDropsByAdminResponse, zGetIdByDownloadByFilesByAdminResponse, zGetGroupsByAdminResponse, zGetPayoutsByAdminResponse, zGetQueryBySearchByAdminResponse, zGetWalletsByAdminResponse, zGetIdByWalletsByAdminResponse, zGetArtistsByMusicResponse, zPostArtistsByMusicResponse, zGetDropsByMusicResponse, zGetIdByDownloadByDropByDropsByMusicResponse, zGetIdByDropsByMusicResponse, zPostShareByDropsByMusicResponse, zGetIdByShareByDropsByMusicResponse, zGetFulldropByMusicResponse, zGetGenresByMusicResponse, zGetSongsByMusicResponse, zPostSongsByMusicResponse, zGetIdByDownloadBySongsByMusicResponse, zGetApplicationsByOauthResponse, zGetIdByDownloadByClientByApplicationsByOauthResponse, zGetUserinfoByOauthResponse, zGetPayoutsByPaymentResponse, zGetIdByPayoutsByPaymentResponse, zPutPlaceholderByTasksResponse, zPutUserByUserResponse, zGetWalletResponse, zPutWalletResponse, zGetChatsByWhatsappResponse } from './zod.gen.ts';
...
export const getIdByDownloadByFilesByAdmin = <ThrowOnError extends boolean = false>(options: Options<GetIdByDownloadByFilesByAdminData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetIdByDownloadByFilesByAdminResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
        ...
        responseValidator: async (data) => {
            return await zGetIdByDownloadByFilesByAdminResponse.parseAsync(data);
        },
...
export const getIdByDownloadByDropByDropsByMusic = <ThrowOnError extends boolean = false>(options: Options<GetIdByDownloadByDropByDropsByMusicData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetIdByDownloadByDropByDropsByMusicResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
        ...
        responseValidator: async (data) => {
            return await zGetIdByDownloadByDropByDropsByMusicResponse.parseAsync(data);
        },
...
export const getIdByDownloadBySongsByMusic = <ThrowOnError extends boolean = false>(options: Options<GetIdByDownloadBySongsByMusicData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetIdByDownloadBySongsByMusicResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
        ...
        responseValidator: async (data) => {
            return await zGetIdByDownloadBySongsByMusicResponse.parseAsync(data);
        },
...
export const getIdByDownloadByClientByApplicationsByOauth = <ThrowOnError extends boolean = false>(options: Options<GetIdByDownloadByClientByApplicationsByOauthData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetIdByDownloadByClientByApplicationsByOauthResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
        ...
        responseValidator: async (data) => {
            return await zGetIdByDownloadByClientByApplicationsByOauthResponse.parseAsync(data);
        },
