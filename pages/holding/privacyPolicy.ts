...
appendBody(
    WebGenTheme(
        Content(
            ...
            Grid(
                Label("Privacy Policy").setTextSize("2xl").setFontWeight("bold"),
                Label(`Privacy Policy`).setTextSize("xl").setFontWeight("bold"),
                Label(
                ...
                Label(`Does this Notice apply to all BBN Websites?`).setTextSize("xl").setFontWeight("bold"),
                Label(
                ...
                Label(`What personal information does BBN collect?`).setTextSize("xl").setFontWeight("bold"),
                Label(
                ...
                Label(`How does BBN use the personal information it collects?`).setTextSize("xl").setFontWeight("bold"),
                ...
                Label(`Where does BBN store your information?`).setTextSize("xl").setFontWeight("bold"),
                Label(
                ...
                Label(`Does BBN use your personal information to contact you?`).setTextSize("xl").setFontWeight("bold"),
                ...
                Label(`Does BBN share the information it collects with any third parties?`).setTextSize("xl").setFontWeight("bold"),
                Label(
                ...
                Label(`How long does BBN retain personal information?`).setTextSize("xl").setFontWeight("bold"),
                Label(
                ...
                Label(`How does BBN use cookies or other tracking technologies?`).setTextSize("xl").setFontWeight("bold"),
                Label(
                ...
                Label(`What should you understand about the third-party links that may appear on this website?`).setTextSize("xl").setFontWeight("bold"),
                Label(
                ...
                Label(`What additional information should specific users know?`).setTextSize("xl").setFontWeight("bold"),
                Label("Parents, guardians and children:").setFontWeight("semibold"),
                Label(
                ...
                Label(`Residents of California:`).setFontWeight("semibold"),
                Label(`California Shine the Light Law:\xA0`),
                Label(`California residents may annually request and obtain information that is shared with other businesses for their own direct marketing use within the prior calendar year. BBN does not share your personal information with other businesses for their own direct marketing use.`),
                Label(`California Consumer Privacy Act:\xA0`),
                Label(
